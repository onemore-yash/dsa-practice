...
| 4 | Check Subtree (is S is subtree of T) | Medium | for all node of T with root of S check identical | Tree Comparison +DFS | 27-02-2026 | [Link](https://www.geeksforgeeks.org/problems/determine-if-two-trees-are-identical/1) |
